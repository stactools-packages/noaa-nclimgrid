...
def test_day_indices_local() -> None:
    # pre 1970
    nc_href = "tests/data-files/netcdf/daily/beta/by-month/1951/01/ncdd-195101-grd-scaled.nc"  # noqa
...
def test_day_indices_remote() -> None:
    # pre 1970
    nc_href = "https://nclimgridwesteurope.blob.core.windows.net/nclimgrid/nclimgrid-daily/beta/by-month/1951/01/prcp-195101-grd-scaled.nc"  # noqa
    idx = utils.day_indices(nc_href)
    assert len(idx) == 31
